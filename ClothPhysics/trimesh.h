...
public:
	...
	halfedge_t& halfedge_ref(const index_t i) { return m_halfedges.at(i); }

	halfedge_t& face2he_index(const index_t face_id)
	{
		index_t index = m_face_halfedges.at(face_id);
		return halfedge_ref(index);
	}
