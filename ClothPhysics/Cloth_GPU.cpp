...
void Cloth_GPU::UpdatePositionsFromGPU()
{
...
void Cloth_GPU::UpdateGPUAfterCut()
{
...
void Cloth_GPU::fillTriangles(std::vector<trimesh::triangle_t>& triang)
{
...
glm::ivec2 Cloth_GPU::getNextNeighbor(int n) {
...
void Cloth_GPU::Split(const unsigned int split_index, glm::vec3 planeNormal)
{
...
void Cloth_GPU::FixSprings(vec& faces_above, vec& faces_below, int split_index)
{
...
void Cloth_GPU::FixStructSprings(const vec & vertices_below, int split_index)
{
...
void Cloth_GPU::FixShearSprings(const vec & vertices_below, int split_index)
{
	glm::ivec4 new_spring;
...
void Cloth_GPU::FixBendSprings(const vec & vertices_below, int split_index)
{
	glm::ivec4 new_spring;
...
glm::ivec4 Cloth_GPU::SplitSpring(std::vector<glm::ivec4>& springs, trimesh::index_t split_index, vec indexes_to_remove_from_original)
{
...
unsigned int Cloth_GPU::getReverseDirection(unsigned int direction)
{
...
std::vector<trimesh::index_t> Cloth_GPU::getCommonVertices(vec faces_above, vec faces_below)
{
	vec common_verts;
...
std::vector<trimesh::index_t> Cloth_GPU::getVertices(vec faces)
{
	vec vertices;
...
bool Cloth_GPU::isPointAbovePlane(glm::vec3 p1, glm::vec3 pointOnPlane, glm::vec3 planeNormal)
{
